...
public class ProductController {
    ...
    public BaseResponse<GetProductDetailRes> getProductDetail(@RequestParam("productsIdx") int productsIdx,@RequestParam("userIdx") int userIdx ){
        try{
            int userIdxByJwt=jwtService.getUserIdx();
            //jwt에서 idx추출한것과 userIdx가 같지 않으면
            if(userIdx!=userIdxByJwt){
            ...
            GetProductDetailRes getProductDetailRes=productProvider.getProductDetail(userIdx,productsIdx);
