...
public class ProductController {
    ...
    @ResponseBody
    @GetMapping("/userIdx/{userIdx}")
    public BaseResponse<List<GetProductRes>> getRecommendProduct(@PathVariable("userIdx")int userIdx){
        ...
        try{
            ...
            List<GetProductRes>getProductRes=productProvider.getRecommendProduct(userIdx);
    ...
    @ResponseBody
    @GetMapping("/detail/userIdx/{userIdx}/productIdx/{productIdx}")

    public BaseResponse<GetProductDetailRes> getProductDetail(@PathVariable("userIdx") int userIdx,@PathVariable("productIdx") int productIdx){
        try{
            int userIdxByJwt=jwtService.getUserIdx();
            //jwt에서 idx추출한것과 userIdx가 같지 않으면
            if(userIdx!=userIdxByJwt){
            ...
            GetProductDetailRes getProductDetailRes=productProvider.getProductDetail(userIdx,productIdx);
    ...
    @ResponseBody
    @GetMapping("/payments/userIdx/{userIdx}/productIdx/{productIdx}")

    public BaseResponse<GetProductPaymentRes> getProductPayment(@PathVariable("userIdx") int userIdx,@PathVariable("productIdx") int productIdx){
        ...
        try{
            ...
            GetProductPaymentRes getProductPaymentRes=productProvider.getProductPayment(userIdx,productIdx);
    ...
    @ResponseBody
    @PatchMapping("/status/{productsIdx}")
