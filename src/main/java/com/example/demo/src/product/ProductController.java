...
public class ProductController {
    ...
    @ResponseBody
    @GetMapping("")
    public BaseResponse<List<GetProductRes>> getRecommendProduct(@RequestBody GetProductReq getProductReq){
        ...
        try{
            ...
            List<GetProductRes>getProductRes=productProvider.getRecommendProduct(getProductReq.getUserIdx());
    ...
    public BaseResponse<GetProductDetailRes> getProductDetail(@RequestBody GetProductDetailReq getProductDetailReq ){
        try{
            ...
            GetProductDetailRes getProductDetailRes=productProvider.getProductDetail(getProductDetailReq.getUserIdx(), getProductDetailReq.getProductIdx());
