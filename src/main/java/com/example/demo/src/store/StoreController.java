...
public class StoreController {
    ...
    */
    ...
    /*
    [GET] userIdx(==storeIdx) 조회
     */

    @ResponseBody
    @GetMapping("/store-id")

    public BaseResponse<GetUserIdxFromJWTRes>getStoreIdx(){

        try{
            int userIdxByJwt=jwtService.getUserIdx();
            GetUserIdxFromJWTRes getUserIdxFromJWTRes=new GetUserIdxFromJWTRes(userIdxByJwt);
            return new BaseResponse<>(getUserIdxFromJWTRes);
    ...
    @ResponseBody
    @GetMapping("/reviews/detail/storeIdx/{storeIdx}")
    public BaseResponse<List<GetStoreReviewDetailRes>> getStoreReviewDetail(@PathVariable("storeIdx") int storeIdx){


        try{
            List<GetStoreReviewDetailRes> getStoreReviewDetailRes=storeProvider.getStoreReviewDetail(storeIdx);
            return new BaseResponse<>(getStoreReviewDetailRes);
    ...
    @ResponseBody
    @GetMapping("/review-numbers/storeIdx/{storeIdx}")


    public BaseResponse<GetStoreReviewCountRes> getStoreReviewSum(@PathVariable("storeIdx") int storeIdx){

        try{
            GetStoreReviewCountRes getStoreReviewCountRes=storeProvider.getStoreReviewSum(storeIdx);
            return new BaseResponse<>(getStoreReviewCountRes);
