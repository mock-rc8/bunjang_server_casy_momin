...
public class StoreController {
    ...
    */
    ...
    public BaseResponse<GetStoreReviewDetailRes> getStoreReviewDetail(@PathVariable("storeIdx") int storeIdx){


        try{
            GetStoreReviewDetailRes getStoreReviewDetailRes=storeProvider.getStoreReviewDetail(storeIdx);
