...
public class CategoryController {
    ...
    /*
    [GET] 상품 등록 시 대분류 카테고리 이름 조회
     */
    @ResponseBody
    @GetMapping("/main-category")
    public BaseResponse<List<GetCategoryName>> getMainCategoryName(){

        try{
            List<GetCategoryName>getCategoryName=categoryProvider.getMainCategoryName();
            return new BaseResponse<>(getCategoryName);
    ...
    /*
    [GET] 대분류 카테고리 idx에 해당하는 소분류 카테고리 이름

     */
    @ResponseBody
    @GetMapping("main-category/{mainCategoryIdx}")
    public BaseResponse<List<GetSubCategoryName>> getSubCategoryName(@PathVariable("mainCategoryIdx")int mainCategoryIdx){

        try{
            List<GetSubCategoryName>getCategoryName=categoryProvider.getSubCategoryName(mainCategoryIdx);
            return new BaseResponse<>(getCategoryName);
