...
import com.example.demo.src.category.model.GetCategoryName;
import com.example.demo.src.category.model.GetCategoryProductRes;
import com.example.demo.src.category.model.GetSubCategoryName;
...
public class CategoryDao {
    ...
    public List<GetCategoryName>getMainCategoryName(){

        String getMainCategoryNameQuery="select ID, categoryName from MainCategory";

        return this.jdbcTemplate.query(getMainCategoryNameQuery,(rs,rowNum)->new GetCategoryName(
                rs.getInt("ID"),
                rs.getString("categoryName")
        ));
    }
    ...
    /*
    [GET] 대분류 카테고리 idx에 해당하는 소분류 카테고리 이름 조회
     */
    public List<GetSubCategoryName>getSubCategoryName(int mainCategoryIdx){

        String getMainCategoryNameQuery="select ID,categoryName from SubCategory where mainID=?";

        return this.jdbcTemplate.query(getMainCategoryNameQuery,(rs,rowNum)->new GetSubCategoryName(
                rs.getInt("ID"),
                rs.getString("categoryName")
        ),mainCategoryIdx);
    }
